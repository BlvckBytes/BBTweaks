...
public class AdditionalRecipeSection extends ConfigSection {
  ...
  public AdditionalRecipeSection(InterpretationEnvironment baseEnvironment, InterpreterLogger interpreterLogger) {
  ...
  public void afterParsing(List<Field> fields) throws Exception {
    ...
    try {
      ...
      throw new MappingError("Could not parse additional recipe-syntax \"" + recipe + "\": " + e.getMessage());
    }
  }
}
