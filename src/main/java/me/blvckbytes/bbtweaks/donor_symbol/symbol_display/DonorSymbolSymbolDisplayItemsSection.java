...
@CSAlways
public class DonorSymbolSymbolDisplayItemsSection extends ConfigSection {
  ...
  public ItemStackSection symbol;

  public DonorSymbolSymbolDisplayItemsSection(InterpretationEnvironment baseEnvironment, InterpreterLogger interpreterLogger) {
